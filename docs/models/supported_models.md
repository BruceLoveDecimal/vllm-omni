...
| `SanaWmStreamingPipeline` | SANA-WM streaming (distilled chunk-causal Stage-1, `WS /v1/realtime/video`) | `BBBBruce/SANA-WM_streaming-stage1-diffusers` | ✅︎ | | | | [Repository](https://github.com/vllm-project/vllm-omni/blob/main/recipes/NVIDIA/SANA-WM.md) |
| `SanaWmStreamingTwoStagePipeline` | SANA-WM streaming two-stage (chunk-causal Stage-1 + chunk-causal LTX-2 refiner, `WS /v1/realtime/video`) | `BBBBruce/SANA-WM_streaming-two-stage-diffusers` | ✅︎ | | | | [Repository](https://github.com/vllm-project/vllm-omni/blob/main/recipes/NVIDIA/SANA-WM.md) |
