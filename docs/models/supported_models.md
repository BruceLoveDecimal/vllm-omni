...
| `MiniCPMO45OmniForConditionalGeneration` | Realtime-Venus-Omni, Realtime-Venus-Audio | `inclusionAI/Realtime-Venus` (local `Realtime-Venus-Omni/` or `Realtime-Venus-Audio/` directory) | ✅︎ | | | | [Guide](../serving/full_duplex_api.md#realtime-venus-quick-start) |
