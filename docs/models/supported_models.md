...
| `MageVLForConditionalGeneration` | Mage-VL (image / video understanding) | `microsoft/Mage-VL` | ✅︎ | | | | [Repository](https://github.com/vllm-project/vllm-omni/blob/main/recipes/Microsoft/Mage-VL.md) |
