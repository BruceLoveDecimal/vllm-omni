...
class VoxtralTTSForConditionalGeneration(
    ...
    def __init__(self, *, vllm_config: VllmConfig, prefix: str = ""):
        ...
        if self.model_stage == "audio_generation":
            ...
            # Opt-in: OmniGPUModelRunner attaches req_ids/active_req_ids to the
            # model kwargs only when this is set, so the per-request seeded
            # noise generators can persist across decode steps.
            self.accepts_sampling_req_ids = True
