...
from vllm_omni.diffusion.cache.easycache import EasyCacheBackend
...
def get_cache_backend(cache_backend: str | None, cache_config: Any) -> CacheBackend | None:
    ...
    if cache_backend == "cache_dit":
    ...
    elif cache_backend in ("easy_cache", "easycache"):
        return EasyCacheBackend(cache_config)
        ...
        raise ValueError(
            ...
            "Supported: 'cache_dit', 'tea_cache', 'mag_cache', 'easy_cache', 'step_cache'"
        )
