...
from vllm_omni.diffusion.models.auk.vae.modules.bigvgan import activations
from vllm_omni.diffusion.models.auk.vae.modules.bigvgan.alias_free_torch.act import Activation1d
from vllm_omni.diffusion.models.auk.vae.modules.commons.layers import Conv1d, ConvTranspose1d
from vllm_omni.diffusion.models.auk.vae.modules.commons.ops import init_weights
from vllm_omni.diffusion.models.auk.vae.modules.vits.flows import ResidualCouplingBlock
...
class BigVGANFlowVAE(nn.Module):
    ...
    def encoding_and_normalization(self, sample, sample_lengths=None, *, generator=None):
        ...
        latents = mean + torch.randn(mean.shape, device=mean.device, dtype=mean.dtype, generator=generator) * torch.exp(
            log_std
        )
